...
export type NotificationTemplateDoc = INotificationTemplate<Types.ObjectId,Types.ObjectId,Types.ObjectId> & Document;
...
export const NotificationTemplates: Model<NotificationTemplateDoc> = model<NotificationTemplateDoc>("NotificationTemplates", NotificationTemplateDocDbSchema);
