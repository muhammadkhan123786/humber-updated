...
export type ticketReferenceTypeDoc = ITicketReferenceTypes<Types.ObjectId> &
  Document;
...
export const TicketReferenceTypes: Model<ticketReferenceTypeDoc> =
  model<ticketReferenceTypeDoc>(
    "TicketReferenceTypes",
    ticketReferenceTypeDbSchema
  );
