...
/** Payment frequency */
export const PAYMENT_FREQUENCY = z.enum(["Daily", "Weekly", "Monthly"]);
...
export const DUTY_ROSTER_SCHEMA = z
  .object({
    day: DAYS,
...
export const ADDITIONAL_INFORMATION_SCHEMA = z
  .object({
...
export const TECHNICIAN_SCHEMA_Validation = z.object({
  ...
  technicianStatus: z.enum(TECHNICIAN_STATUS).optional().default("Available"),
