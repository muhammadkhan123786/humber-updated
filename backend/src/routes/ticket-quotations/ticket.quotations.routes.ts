...
import { TechnicianAuthRequest, technicianProtecter } from "../../middleware/auth.middleware";
...
ticketQuotationRouter.put("/:id", technicianProtecter, (req: TechnicianAuthRequest, res: Response, next: NextFunction) => {
  req.body.userId = req.user.userId;
  req.body.technicianId = req.technicianId;
  next();
