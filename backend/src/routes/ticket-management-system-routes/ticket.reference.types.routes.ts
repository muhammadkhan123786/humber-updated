...
import {
  ticketReferenceTypeDoc,
  TicketReferenceTypes,
} from "../../models/ticket-management-system-models/ticket.reference.types.models";
...
const ticketReferenceTypesServices = new GenericService<ticketReferenceTypeDoc>(
  TicketReferenceTypes
);
...
ticketReferenceTypesRouter.delete(
  "/:id",
  ticketReferenceTypesController.delete
);
