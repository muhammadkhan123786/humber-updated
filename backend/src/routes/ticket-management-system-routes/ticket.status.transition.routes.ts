...
import {
  ticketStatusTransitionDoc,
  TicketStatusTransition,
} from "../../models/ticket-management-system-models/ticket.status.transition.models";
...
const ticketStatusTransitionServices =
  new GenericService<ticketStatusTransitionDoc>(TicketStatusTransition);
...
ticketStatusTransitionRouter.get(
  "/:id",
  ticketStatusTransitionController.getById
);
ticketStatusTransitionRouter.post("/", ticketStatusTransitionController.create);
ticketStatusTransitionRouter.put(
  "/:id",
  ticketStatusTransitionController.update
);
ticketStatusTransitionRouter.delete(
  "/:id",
  ticketStatusTransitionController.delete
);
