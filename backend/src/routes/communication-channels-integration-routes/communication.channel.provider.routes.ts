...
import { channelProviderDoc, communicationChannelsProvider } from "../../models/communication-channel-models/provider.models";
...
const channelProviderServices = new GenericService<channelProviderDoc>(communicationChannelsProvider);
...
const channelProviderController = new AdvancedGenericController({
    ...
    searchFields: ["providerName","channelId"]
});
