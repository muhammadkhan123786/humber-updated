...
const NotificationRulesServices = new GenericService<notificationRulesDoc>(
  NotificationRules,
);
...
notificationRulesRouter.put("/:id", NotificationRulesController.update);
notificationRulesRouter.delete("/:id", NotificationRulesController.delete);
