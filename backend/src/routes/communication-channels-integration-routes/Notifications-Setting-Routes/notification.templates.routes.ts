...
import { NotificationTemplateDoc, NotificationTemplates } from "../../../models/communication-channel-models/Notifications-models/notification.template.models";
...
const NotificationTemplateServices = new GenericService<NotificationTemplateDoc>(NotificationTemplates);
...
notificationTemplateRouter.post("/",validateTemplateVariables, NotificationTemplateController.create);
notificationTemplateRouter.put("/:id",validateTemplateVariables, NotificationTemplateController.update);
notificationTemplateRouter.delete("/:id", NotificationTemplateController.delete);
