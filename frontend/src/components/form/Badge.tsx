...
const badgeVariants = cva(
  // Base classes
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 transition-all",
  {
    variants: {
      variant: {
        ...
        shimmer: "border-transparent animate-shimmer text-white bg-primary",
