...
const TicketInformation = ({
  ...
  const customerName = ticket?.customer?.firstName
    ? ticket.customer.firstName +
      (ticket.customer.lastName ? ` ${ticket.customer.lastName}` : "")
    : "N/A";

  const productName =
    ticket?.vehicle?.vehicleBrandId?.brandName &&
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span
                className={`inline-flex items-center px-3 py-1 rounded-full text-white text-sm font-medium ${getStatusColor(ticket?.ticketStatus || "unknown")}`}
              >
