  ...
  const loadTickets = async () => {
    ...
    try {
      ...
      const availableTickets = response.tickets.filter((ticket: Ticket) => {
        ...
        console.log(
          `Ticket ${ticket.ticketCode} status:`,
          ticket.ticketStatus,
          "lowercase:",
          status,
        );
    ...
    <div className="bg-white rounded-b-2xl border-t-4 border-blue-500 shadow-lg p-6 pt-10 animate-slideUp">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className=" font-medium text-gray-900 leading-none">
            Available Tickets - Created Status
          </h2>
        </div>
      ...
      <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <div className="flex items-center gap-2 text-sm text-blue-800">
          ...
          <p>
            Showing tickets with <strong>created</strong>status only. Click
            Create Quote to generate a quotation for the selected ticket.
          </p>
        </div>
      </div>
    </div>
