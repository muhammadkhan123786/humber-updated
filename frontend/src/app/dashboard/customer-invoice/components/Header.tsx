...
const Header = () => {
  return (
    <div className="w-full  h-32 pl-8 pt-8 bg-linear-to-r from-green-600 via-emerald-600 to-teal-600 rounded-2xl shadow-2xl flex flex-col justify-start items-start overflow-hidden relative">
      <div className="absolute -top-5 left-[100px] w-24 h-24 rotate-130 bg-white/10 rounded-2xl shadow-xl pointer-events-none" />

      <div className="w-full max-w-6xl h-16 flex justify-between items-center z-10">
