...
import { Share2, Plus, Search, Loader2, LayoutGrid, Table2 } from "lucide-react";
...
export default function VehicleCustomerSourceClient() {
  ...
  const { 
    ...
    deleteItem, 
    updateItem 
  } = useFormActions<CustomerSourceWithId>(
    "/customer-source", 
    "customerSources", 
    "Customer Source", 
    currentPage, 
        ...
        <div className="bg-linear-to-r from-blue-600 via-cyan-500 to-teal-600 rounded-2xl p-6 md:p-7 text-white shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-slideInLeft">
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex-1 md:flex-none">
              <h1 className="text-3xl md:text-4xl font-bold">Customer Sources</h1>
              <p className="text-blue-100 text-sm md:text-lg">Manage lead origin categories</p>
            </div>
          </div>
          <button
            onClick={() => {
