  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        <FormInput label="Bank Name" placeholder="Barclays Bank" required />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormInput label="Account Number" placeholder="12345678" required />
          <FormInput label="Sort Code" placeholder="12-34-56" required />
        </div>
      </div>
