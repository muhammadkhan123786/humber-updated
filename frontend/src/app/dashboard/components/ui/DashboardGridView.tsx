    ...
    return (
        <div className="w-full rounded">
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card gradientClass="to-indigo-100 h-56">
                ...
                <Card gradientClass="to-green-100 h-56">
                ...
                <Card gradientClass="to-amber-100 h-56">
                ...
                <Card gradientClass="to-violet-100 h-56">
                ...
                <Card gradientClass="to-fuchsia-100 h-56">
                ...
                <Card gradientClass="to-sky-100 h-56">
