        ...
        <>
            <div className="bg-white p-4">
                ...
                <div className="grid grid-cols-5 justify-between p-2 gap-4">
                    <h1 className="font-semibold md:font-bold text-sm text-slate-500">Online Store</h1>
                    <h1 className="font-semibold md:font-bold text-sm text-slate-500">Customer</h1>
                    <h1 className="font-semibold md:font-bold text-sm text-slate-500">Repair Date</h1>
                    <h1 className="font-semibold md:font-bold text-sm text-slate-500">Amount</h1>
                    <h1 className="font-semibold md:font-bold text-sm text-slate-500">Status</h1>
                </div>
                {/**Data */}
                {orders.map((order) => {
                    return (
                        <div key={order._id} className="grid grid-cols-5 justify-between p-2 gap-4">
