    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[800px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          {/* Select PO and Receiver Info */}
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="po">Select Purchase Order *</Label>
              <Select value={selectedPO} onValueChange={onSelectPO}>
                <SelectTrigger className="border-2 border-blue-100 hover:border-blue-300 focus:border-blue-400">
                      ...
                      <tr key={item.id} className="border-t border-gray-100">
                        ...
                        <td className="p-3">
                          <Select
                            ...
                            onValueChange={(value) =>
                              onUpdateItem(item.id, "condition", value)
                            }
                          >
          ...
          {/* Add Manual Product */}
          <div className="space-y-2">
            <Label htmlFor="manualProduct">Add Manual Product</Label>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
