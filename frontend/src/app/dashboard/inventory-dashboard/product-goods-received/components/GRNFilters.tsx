        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#06b6d4]" />
              <Input
            ...
            <select
              ...
              className={cn(
                "h-12 px-4 rounded-md border-2 border-[#cffafe]",
                "hover:border-[#a5f3fc] focus:border-[#06b6d4] focus:outline-none transition-colors"
              )}
            >
              {statuses.map(status => (
