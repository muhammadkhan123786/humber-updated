          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-blue-50 to-cyan-50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Category Hierarchy</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Price</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Inventory</th>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mt-1">{product.manufacturer}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      ...
                      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-3 border border-indigo-200">
                        <div className="space-y-1.5 text-xs">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="font-bold text-indigo-700">{product.onHand}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-gray-600 font-medium">Reserved:</span>
                            <span className="font-bold text-amber-700">{product.reserved}</span>
                          </div>
                          <div className="flex justify-between items-center border-t border-indigo-200 pt-1.5">
                            <span className="text-gray-600 font-medium">Available:</span>
                            <span className="font-bold text-emerald-700">{product.available}</span>
                          </div>
                          <div className="flex justify-between items-center border-t border-indigo-200 pt-1.5">
                            <span className="text-gray-600 font-medium">Reorder:</span>
                            <span className="font-bold text-purple-700">{product.reorderLevel} / {product.reorderQuantity}</span>
                          </div>
                        </div>
                      </div>
                    </td>
