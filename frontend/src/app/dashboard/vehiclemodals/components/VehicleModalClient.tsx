...
import { CarFront, Plus, Search, Loader2, LayoutGrid, Table2 } from "lucide-react";
...
export default function VehicleModelClient() {
  ...
  const { 
    ...
    deleteItem, 
    updateItem 
  } = useFormActions<VehicleModelWithId>(
    "/vechilemodel", 
    "vehicleModels", 
    "Vehicle Model", 
    currentPage, 
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const allDataRes = await getAll<VehicleModelWithId>("/vechilemodel", {
          limit: "1000", 
