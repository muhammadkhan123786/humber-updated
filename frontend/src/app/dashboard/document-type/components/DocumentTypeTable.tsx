...
import { Star, Files, Trash2 } from "lucide-react";
import { IDocumentType } from "../../../../../../common/IDocument.types.interface";

interface Props {
  data: (IDocumentType & { _id: string })[];
  displayView: "table" | "card";
  onEdit: (item: IDocumentType & { _id: string }) => void;
...
const DocumentTypeTable = ({ data, displayView, onEdit, onDelete, onStatusChange, themeColor }: Props) => {
  // Card View
  if (displayView === "card") {
    return (
