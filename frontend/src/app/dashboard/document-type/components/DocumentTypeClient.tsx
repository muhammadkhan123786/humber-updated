...
import { Files, Plus, Search, Loader2 } from "lucide-react";
...
export default function DocumentTypeClient() {
  ...
  const [editingData, setEditingData] = useState<DocumentTypeWithId | null>(
    null
  );
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            >
              <Files size={36} /> Document Types
            </h1>
            <p className="text-gray-500">
              Manage categories for uploaded documents
            </p>
          </div>
          <button
            onClick={() => {
