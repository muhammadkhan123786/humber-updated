...
interface Props {
  ...
  onEdit: (item: ITechnicianServiceType & { _id: string }) => void;
...
const TechnicianServiceTable = ({ data, displayView, onEdit, onDelete, onStatusChange }: Props) => {
  if (displayView === "card") {
    return (
...
export default TechnicianServiceTable;