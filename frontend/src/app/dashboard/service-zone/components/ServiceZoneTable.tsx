...
interface Props {
  data: ServiceZoneWithId[];
  displayView: "table" | "card";
  onEdit: (data: ServiceZoneWithId) => void;
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="px-4 pb-4 space-y-3">
              ...
              <div className="pt-4">
                <TableActionButton
                  itemName="service zone"
                  fullWidth={true}
                  onEdit={() => onEdit(item)}
                  onDelete={() => {
                    if (item.isDefault) {
                      return toast.error("Default zones cannot be deleted.");
                    }
      ...
      <table className="w-full text-[16px]! text-left min-w-max">
        <thead className="bg-[#ECFEFF] text=[#364153]! border-b-2 border-gray-200 sticky top-0">
          <tr>
            ...
            <th className="px-6 py-4 font-bold text-gray-700 whitespace-nowrap">Zone Name</th>
