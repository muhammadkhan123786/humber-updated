...
import { Activity, Plus, Search, Loader2, Grid3x3, List, LayoutGrid, Table2, XCircle, CheckCircle } from "lucide-react";
        ...
        <div className="bg-white p-5 pt-9 border-t-4! border-[#2B7FFF]! ">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-4 mb-6">
            <div className="space-y-1">
              <h2 className="text-2xl font-bold bg-linear-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Status List</h2>
              <p className="text-sm text-gray-500">Configure job status options for technician workflows</p>
            </div>
