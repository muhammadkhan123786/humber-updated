    ...
    <div className="min-h-screen p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <StatsCards 
          ...
          inactiveCount={dataList.length - activeCount}
        />
        ...
        <div className="bg-white p-5 pt-9 border-t-4! border-[#FE6B1D]! ">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-2 bg-linear-to-r from-gray-100 to-gray-200 rounded-xl p-1">
              <button onClick={() => setDisplayView("card")} className={`px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-all ${displayView === "card" ? "bg-linear-to-r from-orange-500 to-amber-600 text-white shadow-lg" : "text-gray-600 hover:text-gray-900"}`}>
                <Grid3x3 size={16} /> <span className="hidden sm:inline text-sm">Grid</span>
              </button>
              <button onClick={() => setDisplayView("table")} className={`px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-all ${displayView === "table" ? "bg-linear-to-r from-orange-500 to-amber-600 text-white shadow-lg" : "text-gray-600 hover:text-gray-900"}`}>
