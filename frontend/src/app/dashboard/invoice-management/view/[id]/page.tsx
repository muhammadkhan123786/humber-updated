    ...
    <div className=" min-h-screen">
      <div className="w-full mx-auto h-9 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div className="h-6 px-2 flex items-center gap-1 bg-green-100 rounded-[10px] border border-green-300">
            <CheckCircle2 className="w-3 h-3 text-green-700" />
            <span className="text-green-700 text-xs font-normal font-['Arial']">
              Paid
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="h-9 px-4 flex items-center gap-2 bg-linear-to-r from-blue-600 to-indigo-600 rounded-[10px] shadow-md hover:opacity-90 transition-all text-white">
        ...
        <div className="flex justify-between items-start mb-12">
          <div className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600">#INV-2026-001</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="mt-1">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                45 High Street, Manchester,
                <br />
                M1 2AB, United Kingdom
              </p>
              <div>
                <p className="text-gray-600 text-sm ">margaret.t@email.com</p>
                <p className="text-gray-600 text-sm">555-0123</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 flex justify-end">
          <div className="w-full max-w-xs space-y-3">
            ...
            <div className="flex justify-between items-center px-2">
              ...
              <span className="font-bold text-blue-600">£17.00</span>
            </div>
            <div className="flex justify-between items-center px-2">
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.15em]">
                Amount Paid
              </span>
              <span className="font-semibold text-green-600">£137.00</span>
            </div>
