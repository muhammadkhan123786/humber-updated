      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-white p-5 pt-9 border-t-4! border-[#2B7FFF]! ">
          ...
          {loading ? (
            ...
            <>
              <JobTitleTable data={dataList} displayView={displayView} onEdit={(item) => { setEditingData(item); setShowForm(true); }} onDelete={handleDelete} themeColor={THEME_COLOR} />
