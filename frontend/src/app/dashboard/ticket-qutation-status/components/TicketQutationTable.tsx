...
interface Props {
  data: (ITicketQuationStatus & { _id: string })[];
  displayView: "table" | "card";
  onEdit: (item: ITicketQuationStatus & { _id: string }) => void;
  onDelete: (id: string) => void;
  onStatusChange?: (id: string, newStatus: boolean) => void;
  themeColor: string;
}

// Icon colors for different status
...
const TicketQutationTable = ({ data, displayView, onEdit, onDelete, onStatusChange, themeColor }: Props) => {
  // Card View
  if (displayView === "card") {
    return (
...
export default TicketQutationTable;