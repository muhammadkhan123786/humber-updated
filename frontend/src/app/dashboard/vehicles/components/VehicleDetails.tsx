                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="space-y-3 border-t border-gray-100 pt-4">
                                    {vehicle.serialNumber && (
                                        <div>
                                            <p className="text-xs font-bold text-gray-500 uppercase">Serial Number</p>
                                            <p className="text-sm font-bold text-gray-900">{vehicle.serialNumber}</p>
                                        </div>
                                    )}
                                    ...
                                    {vehicle.vehicleRegistrationNumberId && (
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">{vehicle.vehicleRegistrationNumberId}</p>
                                        </div>
                                    )}
                                    ...
                                    {vehicle.colorId && (
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">
                                                {vehicle.colorId?.name || vehicle.colorId}
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    {vehicle.fuelType && (
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">{vehicle.fuelType}</p>
                                        </div>
                                    )}
                                    ...
                                    {vehicle.yearOfManufacture && (
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">{vehicle.yearOfManufacture}</p>
                                        </div>
                                    )}

                                    {vehicle.engineNumber && (
                                        <div>
                                            <p className="text-xs font-bold text-gray-500 uppercase">Engine Number</p>
                                            <p className="text-sm font-bold text-gray-900">{vehicle.engineNumber}</p>
                                        </div>
                                    )}

                                    {vehicle.chassisNumber && (
                                        <div>
                                            <p className="text-xs font-bold text-gray-500 uppercase">Chassis Number</p>
                                            <p className="text-sm font-bold text-gray-900">{vehicle.chassisNumber}</p>
                                        </div>
                                    )}

                                    {vehicle.transmission && (
                                        <div>
                                            <p className="text-xs font-bold text-gray-500 uppercase">Transmission</p>
                                    ...
                                    {vehicle.mileage && (
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-gray-900">{vehicle.mileage} km</p>
                                        </div>
                                    )}

                                    {vehicle.licensePlate && (
                                        <div>
                                            <p className="text-xs font-bold text-gray-500 uppercase">License Plate</p>
                                            <p className="text-sm font-bold text-gray-900">{vehicle.licensePlate}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
