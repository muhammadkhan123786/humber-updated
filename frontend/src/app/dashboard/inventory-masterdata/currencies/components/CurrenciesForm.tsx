...
const CurrenciesForm = ({ editingData, onClose, onRefresh, themeColor, apiUrl }: Props) => {
      ...
      <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="p-6 text-white flex justify-between items-center" style={{ backgroundColor: themeColor }}>
          <h2 className="text-xl font-bold flex items-center gap-2">
            <DollarSign size={24} /> {editingData ? "Edit Currency" : "Add New Currency"}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          {/* Currency Name */}
          <div>
            <label className="block text-sm font-semibold mb-2 text-gray-700">Currency Name *</label>
            <input
              required
              placeholder="e.g. US Dollar, Saudi Riyal"
          ...
          {/* Currency Symbol */}
          <div>
            <label className="block text-sm font-semibold mb-2 text-gray-700">Symbol *</label>
            <input
              required
              placeholder="e.g. $, SAR, PKR"
              className="w-full border rounded-xl p-3 outline-none focus:ring-2 transition-all border-gray-200"
