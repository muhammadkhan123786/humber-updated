...
type FormData = z.infer<typeof proposedActionSchema>;
...
const PurposedActionForm = ({ editingData, onClose, themeColor }: Props) => {
  ...
  return (
    <FormModal
      title={editingData ? "Edit Proposed Action" : "Add Proposed Action"}
      icon={<Zap size={24} />}
      onClose={onClose}
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-4">
        <FormInput
          label="Proposed Action Name *"
          placeholder="e.g. Call Customer, Send Quote"
          {...register("proposedActionName")}
          error={errors.proposedActionName?.message}
        />
