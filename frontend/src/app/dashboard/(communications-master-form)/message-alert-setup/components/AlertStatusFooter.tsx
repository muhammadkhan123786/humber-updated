...
interface AlertStatusFooterProps {
  isActive: boolean;
    ...
    <div className="space-y-4 mt-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[12px] text-slate-500">
              This alert is currently {isActive ? "active" : "inactive"}
            </p>
          </div>
        </div>
        <span
          className={`${isActive ? "bg-[#00D27A]" : "bg-gray-400"} text-white text-[11px] px-4 py-1.5 rounded-lg font-bold`}
        >
      ...
      <div className="flex gap-3 h-10">
        ...
        <button
          type="button"
          onClick={onCancel}
          className="px-6 bg-white border border-slate-200 text-slate-600 rounded-xl font-bold flex items-center gap-2 hover:bg-slate-50 transition-all"
        >
          <X size={18} />
          Cancel
        </button>
