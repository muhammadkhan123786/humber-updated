...
export const navigation: INavBarLinkSharedInterface[] = [
  ...
  /* ================= MASTER DATA ================= */
  {
    ...
    subItems: [
      ...
      { _id: nanoid(), label: "Business Types", href: "/dashboard/business-types", icon: Briefcase, roleId: [1] },
      { _id: nanoid(), label: "Product & Services", href: "/dashboard/product-services", icon: ShoppingCart, roleId: [1] },
      { _id: nanoid(), label: "Icons", href: "/dashboard/icon", icon: ShoppingCart, roleId: [1] },
      { _id: nanoid(), label: "Job Titles", href: "/dashboard/job-title", icon: Tags, roleId: [1] },
      { _id: nanoid(), label: "Ticket Statuses", href: "/dashboard/ticket-masterdata/ticket-status", icon: Radio, roleId: [1] },
      { _id: nanoid(), label: "Departments", href: "/dashboard/ticket-masterdata/department", icon: Users, roleId: [1] },
      { _id: nanoid(), label: "Ticket Actions", href: "/dashboard/ticket-masterdata/ticket-actions", icon: BarChart3, roleId: [1] },
      { _id: nanoid(), label: "Ticket Types", href: "/dashboard/ticket-masterdata/ticket-type", icon: Activity, roleId: [1] },
      { _id: nanoid(), label: "Ticket Transitions", href: "/dashboard/ticket-masterdata/ticket-transition", icon: ShieldCheck, roleId: [1] },
      { _id: nanoid(), label: "Ticket Reference Types", href: "/dashboard/ticket-masterdata/ticketReferenceTypes", icon: ShoppingCart, roleId: [1] },
