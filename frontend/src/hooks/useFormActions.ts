...
export const useFormActions = <T extends { _id: string }>(
  ...
  const updateMutation = useMutation({
    ...
    onError: (err: any) => {
      toast.error(
        err.response?.data?.message || `Failed to update ${moduleName}`,
      );
    },
  });
  ...
  const createMutation = useMutation({
    ...
    onError: (err: any) => {
      toast.error(
        err.response?.data?.message || `Failed to create ${moduleName}`,
      );
    },
  });
    ...
    onError: (err: any) => {
      toast.error(
        err.response?.data?.message ||
          `Failed to Test Connection ${moduleName}.`,
      );
    },
  });
  ...
  const syncData = useMutation({
    ...
    onError: (err: any) => {
      alert(
        err.response?.data?.message || `Failed to Sync Data ${moduleName}.`,
      );
    },
  });
